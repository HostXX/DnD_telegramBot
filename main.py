...
from dice import *
updater = Updater('<The API-KEY of your telegram bot>')
...
updater.dispatcher.add_handler(CommandHandler('setdm', setDM))
updater.dispatcher.add_handler(CommandHandler('changehealth', alterHealth))
updater.dispatcher.add_handler(CommandHandler('createcharacter', createCharacter))
updater.dispatcher.add_handler(CommandHandler('printcharacterstats', printCharacterStats))
updater.dispatcher.add_handler(CommandHandler('updateinventory', inventoryUpdate))
updater.dispatcher.add_handler(CommandHandler('printinventory', printInventory))
updater.dispatcher.add_handler(CommandHandler('changegold',alterGold))
updater.dispatcher.add_handler(CommandHandler('changexp',alterExperience))

updater.dispatcher.add_handler(CommandHandler("roll",rollDice))
    
updater.dispatcher.add_handler(CommandHandler('createmonster', createMonster))
updater.dispatcher.add_handler(CommandHandler('attackmonster', attackMonster))



updater.dispatcher.add_handler(MessageHandler(Filters.all,incomingMessages))
